# -*- coding: utf-8 -*-
"""Module-6-Lab-tts_solution.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SJ-u-CL_daFvjXlG_gMo1iw8UpOxbZyd
"""
...
while True:
    ...
    dc = PyDictionary()
    output = dc.translate(text,"en")
    #output = dc.synonym(output)
    #output = dc.printMeanings(text)
